...
public class CEduacion {
   ...
   @DeleteMapping("/delete/{id}")
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        if(sEducacion.existsByNombreE(dtoeducacion.getDescripcionE())){
            return new ResponseEntity(new Mensaje("Ese descripion ya esta agregada"), HttpStatus.BAD_REQUEST); 
        }
        
        
        Educacion educacion = new Educacion(dtoeducacion.getNombreE(), dtoeducacion.getDescripcionE(), dtoeducacion.getImg(), dtoeducacion.getAnocomienzo());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion){       
        ...
        educacion.setAnocomienzo(dtoeducacion.getAnocomienzo());
